...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'washwish.railway.app,washwish-production.up.railway.app,localhost,127.0.0.1,.railway.app,.up.railway.app').split(',')
